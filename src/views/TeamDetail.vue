  ...
  <Team :team_type_id="team.team_type_id" :workTypes="workTypes">
    <div id="team-detail" class="team-detail">
      ...
      <div class="team-detail__personal-information p-5">
        <div class="row">
          <div class="team-detail__number font-weight-bold p-3 text-center">
            {{ team.number }}
          </div>
        ...
        <div class="mt-5">
          <div class="row">
            <div class="col col-md-4 personal-information p-3">
              <h4 class="personal-information__title pb-2 font-weight-bold">
            ...
            <div class="col-md-8">
              <div class="biography p-3">
                <div class="biography__navigation my-5"></div>
                <h1 class="font-weight-bold">BIOGRAPHY</h1>
                <div
                  class="biography__media p-4 bg-light"
                  v-html="team.biography"
                ></div>
              </div>
            </div>
          </div>
