  ...
  <div>
    <Ticket>
      <div class="matches p-5">
        <h3 class="text-uppercase text-primary font-weight-bold mb-2">
          Matches
        </h3>
        <div
          ...
          <div class="row">
            <div class="col-md-5">
              <div>
                ...
                <p>
                  {{ match.opponent.stadium }} | {{ match.date }},
                  {{ match.time }}
                </p>
              </div>
              <div class="mt-4">
            ...
            <div class="col-md-6">
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr
                      v-for="(cat, index) in match.ticket_categories"
                      :key="index"
                    >
