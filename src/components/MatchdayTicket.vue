    ...
    <div>
        <div class="matches p-5">
            <div 
                ...
                :key="index"
            >
                <div class="row bg-light p-3 mb-3 matches-card" @click="togglePackages(match)">
                    <div class="col-md-9">
                        <div>
                            ...
                            <span class="font-weight-bold text-primary">{{ match.opponent.name }}</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <h6 class="font-weight-bold text-primary">{{ match.competition.name }}</h6>
                    ...
                    <div v-for="(pack,index) in match.packages" :key="index">
                        <div class="row mb-3 bg-light">
                            ...
                            <div class="col-md-4 p-3">
                                <h3>{{ pack.name }}</h3>
                                <div class="mt-5">
                                    <h3><span class="text-success">£{{ pack.price }}</span></h3>
                                    <a href="" class="btn btn-warning text-white font-weight-bold">LIMITED</a>
                                </div>
                            </div>
                            <div class="col-md-4 p-3">
